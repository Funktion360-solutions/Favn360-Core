...
export type Database = {
  ...
  public: {
    Tables: {
      ai_analyses: {
        Row: {
          ...
          citizen_id: string
          citizen_reflection: Json | null
          created_at: string | null
          critical_observations: Json | null
          functional_themes: Json | null
      ...
      ai_summaries: {
        Row: {
          citizen_id: string
          citizen_own_descriptions: string | null
          created_at: string
          date_citations: Json | null
          development: string | null
          functional_description_suggestions: string | null
          generated_at: string
          generated_by_ai: boolean
          id: string
          objective_observations: string | null
          patterns_over_time: string | null
          period_end: string | null
          period_start: string | null
          source_diary_entry_id: string | null
      ...
      attachments: {
        Row: {
          citizen_id: string
          context: Database["public"]["Enums"]["attachment_context"]
          created_at: string
      ...
      citizen_consents: {
        Row: {
          ...
          representative_sharing: boolean
        }
        Insert: {
          accepted_at?: string
          ai_analysis?: boolean
      ...
      citizen_employment: {
        Row: {
          cash_benefits: boolean
          citizen_id: string
          created_at: string
          disability_pension: boolean
          id: string
          in_practice: boolean
          job_clarification: boolean
          practice_company: string | null
          practice_contact_person: string | null
          practice_end_date: string | null
          practice_hours_per_week: number | null
          practice_start_date: string | null
          resource_program: boolean
          sick_leave: boolean
          sickness_benefits: boolean
          updated_at: string
        }
        Insert: {
          cash_benefits?: boolean
      ...
      diary_entries: {
        Row: {
          ...
          calculated_work_minutes: number | null
          challenge_handling: string | null
          citizen_id: string
          colleague_cooperation: string | null
          completed_home_tasks: string | null
          created_at: string
          ...
          fatigue_waking: number | null
          functional_level: number | null
          had_practice_day: boolean | null
          home_day_description: string | null
          hygiene_body_wash: boolean | null
          hygiene_brushed_hair: boolean | null
          hygiene_brushed_teeth: boolean | null
          hygiene_dressing: boolean | null
          hygiene_hair_wash: boolean | null
          hygiene_makeup: boolean | null
          id: string
      ...
      functional_description_versions: {
        Row: {
          created_at: string
          created_by: string | null
          functional_description_id: string
          id: string
          snapshot: Json
          version_number: number
        }
      ...
      functional_descriptions: {
        Row: {
          ...
          id: string
          section_1_primary_challenges: string | null
          section_10_development_options: string | null
          section_2_daily_rhythm_routines: string | null
          section_3_shopping_cooking_meals: string | null
          section_4_cleaning_laundry_bedding: string | null
          section_5_personal_care: string | null
          section_6_house_garden_work: string | null
          section_7_transport: string | null
          section_8_communication: string | null
          section_9_social_relations: string | null
          status: Database["public"]["Enums"]["functional_description_status"]
          updated_at: string
          updated_by: string | null
        }
        Insert: {
    ...
    Functions: {
      can_access_citizen: { Args: { citizen_uuid: string }; Returns: boolean }
      can_represent_citizen: {
        Args: { citizen_uuid: string }
        Returns: boolean
      }
      create_default_practice_schedule: {
        Args: { target_citizen_id: string }
        Returns: undefined
      }
      current_user_role: {
        Args: never
      ...
      is_representative: { Args: never; Returns: boolean }
      owns_citizen: { Args: { citizen_uuid: string }; Returns: boolean }
    }
    Enums: {
      app_role: "citizen" | "administrator"
      attachment_context:
        | "diary_day"
        | "practice_day"
      ...
      user_role: "citizen" | "administrator" | "representative"
    }
    CompositeTypes: {
      [_ in never]: never
    }
